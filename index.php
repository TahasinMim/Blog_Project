      ...
      <div class="container-fluid">
        <div class="owl-banner owl-carousel">
          ...
          <?php
			...
			$slider_blogs=mysqli_query($connection,$query);
			while($row=mysqli_fetch_assoc($slider_blogs)){
				$blog_id=$row['blog_id'];
			...
			?>
          <div class="item">
            <img src="assets/images/<?php echo $blog_image;  ?>">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
<!--                  <span>Nature</span>-->
                </div>
                <a href="post-details.php"><h4><?php echo $blog_title;  ?></h4></a>
                <div class="main-button">
                    <a  href="post-details.php?b_id=<?php echo $blog_id; ?>" >Explore Site</a>
                  </div>
                <ul class="post-info">
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="all-blog-posts">
              <div class="row">
                 <?php	  
				$query_all_blog="SELECT * FROM blogs WHERE blog_status='published' LIMIT 3";
				$all_blogs=mysqli_query($connection,$query_all_blog);
                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      ...
                      <a href="blog.php?b_id=<?php echo $blog_id; ?>"><h4><?php echo $blog_title;  ?></h4></a>
                      <ul class="post-info">
                        <li><a href="#"><?php echo $blog_author;  ?></a></li>
                        <li><a href="#"><?php echo $blog_date;  ?></a></li>
                        <li><a href="#"><?php echo $blog_comment;  ?> comments</a></li>
                      ...
                      <div class="post-options">
                         ...
                         <div class="row">
                          ...
                          <div class="col-3">
                          <div class="main-button">
                    		<a  href="post-details.php?b_id=<?php echo $blog_id; ?>" >Read More</a>
                  			</div>
                          </div>
                        </div>
                      </div>
                    ...
                    <form id="search_form" method="Post" action="Search.php">
                      <div class="input-group mb-3">
    					...
    					<div class="input-group-append">
      					<button class="btn btn-warning" name="sub" type="submit">Go</button>  
     					</div>
  					</div>
                    </form>
                </div>
