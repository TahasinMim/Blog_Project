    	...
    	<div class="col-lg-12">
                       ...
                       <tbody>
                        <?php
							...
							$display_msg=mysqli_query($connection,$query);
							while($row=mysqli_fetch_assoc($display_msg)){
								$msg_id=$row['msg_id'];
...
//								} 
								...
								echo "<td><a href=messages.php?delete={$msg_id}>Delete</td>";
...
//									}
									if(isset($_GET['delete'])){
										...
										$query="DELETE FROM messages WHERE msg_id='$Delete_message_Id'";
										$deleting_msg_table=mysqli_query($connection,$query);
										if($deleting_msg_table){
