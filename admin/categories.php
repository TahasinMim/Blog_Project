	   ...
	   <div class="row">
   		...
   		<?php 
			...
			if(isset($_POST['submit'])){
					...
					if($cat_title=="" || empty($cat_title)){
					 echo "<i>This field should not be empty</i>";
					} else{
   		...
   		<div class="col-md-4">
                    	...
                    	<tbody>
							...
							$make_category_table=mysqli_query($connection,$query);
							while($row=mysqli_fetch_assoc($make_category_table)){
								$cat_id=$row['cat_id'];
                  			...
                  			<?php
								...
								$delete_each_category=mysqli_query($connection,$query);
